...
public class SeckillOrderController {
    ...
    public PageInfo<TbSeckillOrder> findPage(@RequestParam(value = "pageNo", defaultValue = "1", required = true) Integer pageNo,
		...
		PageInfo<TbSeckillOrder> page = seckillOrderService.findPage(pageNo, pageSize, seckillOrder);
	...
	return seckillOrderService.findOrderList(name,id);
	}
