...
public class SeckillGoodsController {
	...
	public Map getGoodsById(Long id){
		Map map = seckillGoodsService.getGoodsById(id);
		return map;
	}
	...
	public List<TbSeckillGoods> findByStatus(){
		return seckillGoodsService.findByStatus();
	}
	 ...
	 */
	@RequestMapping("/add")
	public Result add(@RequestBody TbSeckillGoods seckillGoods, @RequestParam(value = "startTime") String startTime, @RequestParam(value = "endTime") String endTime ){
		try {
			...
			seckillGoods.setEndTime(endTime1);
			seckillGoods.setStartTime(startTime1);
