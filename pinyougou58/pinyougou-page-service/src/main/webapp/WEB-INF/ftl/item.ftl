                    ...
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <#--<dd><a href="javascript:;">银色</a></dd>-->
                            <dd>
                                ...
                                <a href="javascript:;" :class="{selected:isSelected('${spec.attributeName}','${value}')}" @click="selectSpecifcation('${spec.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a>
                                </#list>
                            </dd>
                        </dl>
                        </#list>
                    ...
                    <div class="summary-wrap">
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    <input autocomplete="off" type="text" value="1" v-model="num" minnum="1" class="itxt"/>
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="cart.html" @click="addGoodsToCartList()" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
